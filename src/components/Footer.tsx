        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12 px-4 lg:px-8">
          ...
          <div className="flex flex-col gap-6 max-w-xs">
            <div className="flex items-center gap-2">
              <img src="/logo-green.svg" alt="J.J Thai Spa Logo" className="h-8 w-8 object-contain" />
          ...
          <div className="max-w-xs">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+15088070141" className="text-white/70 hover:text-primary transition-colors text-sm">
                  (508) 807-0141
                </a>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary">sms</span>
                <a href="sms:+18333752584" className="text-white/70 hover:text-primary transition-colors text-sm">
