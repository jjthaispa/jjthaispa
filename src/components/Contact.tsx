                                ...
                                <ul className="space-y-6">
                                    ...
                                    <li className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+15088070141" className="text-text-light/70 dark:text-text-dark/70 hover:text-primary transition-colors">
                                                (508) 807-0141
                                            </a>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="sms:+18333752584" className="text-text-light/70 dark:text-text-dark/70 hover:text-primary transition-colors">
                                                (833) 375-2584
                                            </a>
                                        </div>
                                    </li>
