...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="bg-background-light dark:bg-background-dark min-h-screen flex flex-col">
      <Helmet>
        <title>Privacy Policy - J.J Thai Spa</title>
        <meta name="description" content="Learn about how J.J Thai Spa collects, uses, and protects your personal information." />
        <link rel="canonical" href="https://jjthaispa.com/privacy-policy" />
      </Helmet>
      {/* Dark Hero Section */}
