...
export const SERVICES: Service[] = [
    {
        ...
        descriptionMain: "Our Swedish Massage blends long, flowing movements and light kneading with gentle to medium pressure to gently relax muscles, reduce stress, and restore balance.",
        image: "/therapies/swedish2.webp",
        benefits: [
    ...
    },
    {
        ...
        descriptionMain: "A customized blend of Swedish, deep tissue, and Thai techniques tailored to your specific needs and preferences.",
        image: "/therapies/combination.webp",
        benefits: [
    ...
    },
    {
        ...
        descriptionMain: "A therapeutic massage using firm pressure and Thai techniques. Ideal for pain relief, muscle recovery, and improved mobility. Can be enhanced with optional Ashiatsu massage.",
        image: "/therapies/walking2.webp",
        benefits: [
    ...
    },
    {
        ...
        descriptionMain: "Relieve built-up tension where it's felt most. This focused massage targets the neck, back, and shoulders using therapeutic techniques to release tight muscles and ease stress.",
        image: "/therapies/tension.webp",
        benefits: [
    ...
    },
    {
        ...
        descriptionMain: "A gentle, nurturing massage designed specifically for expectant mothers. This treatment helps alleviates common discomforts during pregnancy",
        image: "/therapies/prenatal.webp",
        benefits: [
    ...
    },
    {
        ...
        descriptionMain: "Share a relaxing experience together with designed side-by-side massage and traditional Thai techniques.",
        image: "/therapies/couples.webp",
    ...
    },
    {
        ...
        image: "/therapies/aroma_desk.webp",
